    ...
    <main className="relative">
      <section>
        <div className="max-w-[1950px] p-12 absolute top-14 w-full border ">
          <div className="bg-gray-800 rounded-md flex p-8">
            {/* 왼쪽 배너 */}
            <div className="bg-orange-100 rounded-md m-4">
              <svg
                aria-hidden="true"
                className="fill-orange-500 mb16 svg-spot spotSearch"
                width="48"
                height="48"
                viewBox="0 0 48 48"
              >
            ...
            <div className="bg-blue-100 rounded-md">
              <svg
                aria-hidden="true"
                className="fill-blue-500 mb16 svg-spot spotLock"
                width="48"
                height="48"
                viewBox="0 0 48 48"
              >
